...
export default async function Home() {
  return (
    <div className="article">
      ...
      <p>For <Link href="https://youtu.be/HG3TTsx8PR0">Lie derivative</Link> and <Link href="https://youtu.be/ZXrwhhQAEss?list=TLPQMDgwNTIwMjQR7xLCBuTYXw">Killing vectors</Link>, I used <Link href="https://www.youtube.com/@TensorCalculusRobertDavie">Robert Davie&apos;s</Link> videos and also <Link href="https://phys.libretexts.org/Bookshelves/Relativity/General_Relativity_(Crowell)/07%3A_Symmetries/7.01%3A_Killing_Vectors">Physics LibreTexts</Link> for reference. The Wikipedia page for the <Link href="https://en.wikipedia.org/wiki/Killing_tensor">Killing tensor</Link> was also used in the Killing vectors chapter.</p>
    </div>
  )
}