...
export default async function Home() {
  return (
    <div className="article">
      ...
      <p>Arbitrary vectors are written in bold undercase letters (e.g. <InlineMath math="\boldsymbol{a}, \boldsymbol{v}" />). Physical quantities, like force (<InlineMath math="\boldsymbol{F}" />) are used by standard conventions. Matricies are written in bold uppercase letters (e.g. <InlineMath math="\boldsymbol{R}" />). Points are written in normal uppercase letters (e.g. <InlineMath math="P" />).</p>
